...
public class Medium extends Activity {
	...
	private int preV=-1;
	private int preId=-1;
	pairList P=new pairList(12);
    Button.OnClickListener[] listener=new Button.OnClickListener[24];
	...
	protected void onCreate(Bundle savedInstanceState) {
		Intent med=getIntent();
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_medium);
		getRecord gr=new getRecord();
        record r;
        try {
			r=gr.getRecord(Medium.this, 2);
			final TextView recordShow=(TextView) findViewById(R.id.record);
	        recordShow.setText("Medium Level Record: "+r.getN()+" "+r.getT()+"s");
